...
def load_models():
    loaded_svc = pickle.load(open('./Code/Train/SVC.sav', 'rb'))
    loaded_knn = pickle.load(open('./Code/Train/KNN.sav', 'rb'))
    loaded_rf = joblib.load('./Code/Train/RF.sav')
    loaded_lr = pickle.load(open('./Code/Train/LR.sav', 'rb'))
